...
WHERE (dbo.[t-parken].datumstart < GETDATE()) AND (dbo.[t-parken].datumeind IS NULL OR
             ...
             dbo.[t-straten].datumeind > GETDATE())
GO

EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'v-straten';
GO
...
Begin DesignProperties = 
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'v-straten';
GO
